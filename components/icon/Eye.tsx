export default function IconEye({ ...rest }) {
  return (
    <svg
      {...rest}
      width='24'
    ...
    >
      <path
        d='M15.5801 12C15.5801 13.98 13.9801 15.58 12.0001 15.58C10.0201 15.58 8.42009 13.98 8.42009 12C8.42009 10.02 10.0201 8.41997 12.0001 8.41997C13.9801 8.41997 15.5801 10.02 15.5801 12Z'
        stroke='currentColor'
        stroke-width='1.5'
