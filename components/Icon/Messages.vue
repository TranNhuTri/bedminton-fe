<template>
  ...
  >
    <path
      d="M18.47 16.83L18.86 19.99C18.96 20.82 18.07 21.4 17.36 20.97L13.9 18.91C13.66 18.77 13.6 18.47 13.73 18.23C14.23 17.31 14.5 16.27 14.5 15.23C14.5 11.57 11.36 8.59 7.5 8.59C6.71 8.59 5.94 8.71 5.22 8.95C4.85 9.07 4.49 8.73 4.58 8.35C5.49 4.71 8.99 2 13.17 2C18.05 2 22 5.69 22 10.24C22 12.94 20.61 15.33 18.47 16.83Z"
      fill="currentColor"
    />
    <path
